...
/*
 * SUMMARY:      SnowAtmosphericStability.c
 * USAGE:        Calculate atmospheric stability above the snowpack
 * AUTHOR:       Xiaoxiang Guan
 * ORG:          Section Hydrology, GFZ
 * E-MAIL:       guan@gfz-potsdam.de
 * ORIG-DATE:    Aug-2023
 * DESCRIPTION:  Calculate atmospheric stability and correct the
 *               aerodynamic resistance the snow surface 
 *               and the near-surface reference height
 *                  
 * DESCRIP-END.
 * FUNCTIONS:    
 *               RichardsonNumber(); AerodynamicResistance()
 * COMMENTS:
...
double RichardsonNumber(
    ...
    double z            /* the height (with unit of [m]) of the layer 
                            where the air temperature and wind speed are recored */ 
){
...
double AerodynamicResistance(
    double r_as, /* the aerodynamic resistance between the 
                    snow surface and the near-surface reference height */ 
    double Ri_b  /* Richardson’s number */ 
){
    double Ri_cr = 0.2;
    double r_as_update;
